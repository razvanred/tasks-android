...
class SetTaskExpirationDateById @Inject constructor(
    private val taskRepository: TaskRepository,
    private val dispatchers: AppCoroutineDispatchers,
) : Interactor<SetTaskExpirationDateById.Params>() {
    ...
    operator fun invoke(id: TaskId, expirationDate: LocalDate?) = invoke(
        Params(
            id = id,
    ...
    data class Params(val id: TaskId, val expirationDate: LocalDate?)
}
