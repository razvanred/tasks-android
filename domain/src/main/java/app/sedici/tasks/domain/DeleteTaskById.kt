...
class DeleteTaskById @Inject constructor(
    private val taskRepository: TaskRepository,
    private val dispatchers: AppCoroutineDispatchers,
) : Interactor<DeleteTaskById.Params>() {

    override suspend fun doWork(params: Params) {
        withContext(dispatchers.io) {
            taskRepository.deleteTask(id = params.taskId)
        }
    }

    operator fun invoke(taskId: TaskId) = invoke(Params(taskId = taskId))
